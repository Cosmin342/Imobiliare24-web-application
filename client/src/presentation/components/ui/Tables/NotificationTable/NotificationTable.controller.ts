 ...
 */
export const useNotificationTableController = () => {
    const { getNotifications: { key: queryKey, query }, deleteNotification: { key: deleteUserKey, mutation: deleteUser } } = useNotificationApi(); // Use the API hook.
