 ...
 */
export const useFollowedAnnouncementTableController = () => {
    const { 
        getFollowedAnnouncements: { key: queryKey, query },
        unsubscribeToAnnouncement: { key: deleteAnnouncementKey, mutation: deleteFollowedAnnouncement },
    ...
    const { mutateAsync: deleteMutation } = useMutation([deleteAnnouncementKey], deleteFollowedAnnouncement); // Use a mutation to remove an entry.
