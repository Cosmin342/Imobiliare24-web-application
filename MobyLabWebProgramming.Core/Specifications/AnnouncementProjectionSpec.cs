...
public sealed class AnnouncementProjectionSpec : BaseSpec<AnnouncementProjectionSpec, Announcement, AnnouncementDTO>
{
    ...
    public AnnouncementProjectionSpec(Guid id) : base(id)
    {
    }

    public AnnouncementProjectionSpec(string? search, bool? active, bool? forCurrentUser, Guid userId)
    {
